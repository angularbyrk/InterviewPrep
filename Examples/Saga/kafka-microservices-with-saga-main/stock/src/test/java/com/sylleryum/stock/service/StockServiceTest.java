...
//        currentStockItems.sort(Comparator.comparing(StockItem::getDescription));
        StockItem stockItem = new StockItem("it","item test",10L);
        StockItem stockItem1 = new StockItem("it","item c",10L);
        StockItem stockItem2 = new StockItem("it","item g",10L);
...
//        all.sort(Comparator.comparing(StockItem::getDescription));
    ...
    void save_persistEntity_idCreated() {
        StockItem stockItem = stockService.save(new StockItem("it","item test",10L));
